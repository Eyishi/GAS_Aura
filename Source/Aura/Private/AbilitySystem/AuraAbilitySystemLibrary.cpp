...
void UAuraAbilitySystemLibrary::InitializedDefaultAttributes(const UObject* WorldContextObject,ECharacterClass CharacterClass,
...
void UAuraAbilitySystemLibrary::GiveStartupAbilities(const UObject* WorldContextObject, UAbilitySystemComponent* ASC,ECharacterClass CharacterClass)
{
	...
	FCharacterClassDefaultInfo DefaultInfo = CharacterClassInfo->GetCharacterClassInfo(CharacterClass);
